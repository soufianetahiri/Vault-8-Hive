...
#elif defined(__sparc)				// hive: start changes
#include <sys/isa_defs.h>
#define _BIG_ENDIAN					// hive: end changes
#else
#include <endian.h>
#endif
...
#elif defined(_BIG_ENDIAN)			// hive: start changes
#define POLARSSL_HTONS(n) (n)		// hive: end changes
#else
