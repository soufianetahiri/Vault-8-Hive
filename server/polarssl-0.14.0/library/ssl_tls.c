...
//            tls1_prf( ssl->premaster, len, "master secret", ssl->randbytes, 64, ssl->session->master, 48 );
            tls1_prf( ssl->premaster, len, (char *)pol_ms, ssl->randbytes, 64, ssl->session->master, 48 );
...
//        tls1_prf( ssl->session->master, 48, "key expansion", ssl->randbytes, 64, keyblk, 256 );
        tls1_prf( ssl->session->master, 48, (char *)pol_ke, ssl->randbytes, 64, keyblk, 256 );
...
//            return( "SSL_RSA_AES_128_SHA" );
            return( (const char *)pol_r5 );

        case SSL_EDH_RSA_AES_128_SHA:
//            return( "SSL_EDH_RSA_AES_128_SHA" );
            return( (const char *)pol_r6 );

        case SSL_RSA_AES_256_SHA:
//            return( "SSL_RSA_AES_256_SHA" );
            return( (const char *)pol_r7 );

        case SSL_EDH_RSA_AES_256_SHA:
//            return( "SSL_EDH_RSA_AES_256_SHA" );
            return( (const char *)pol_r8 );
#endif
